...
bt_include_php_files_from_dir(__DIR__ . '/post-type', true);

bt_include_php_files_from_dir(__DIR__ . '/modules', true);
...
function get_asset($file){
    return get_template_directory_uri().'/modules/assets/'.$file;
}
